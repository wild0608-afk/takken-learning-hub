...
function renderGuide() {
  const items = [
    ...
    },
    {
      icon: '🆓',
      title: '無料版と有料版',
      body: '無料版では、4分野から各25問・合計100問を学習できます。有料版では全500問を利用でき、より幅広い問題演習と学習機能が解放されます。',
    },
    {
      icon: '📗',
      title: '無料版でできること',
      body: '無料版では、今日の5問、ランダム10問、4分野各25問の演習、無料問題の復習・付箋・学習記録を利用できます。重要数字マップと混同ポイントは一部を閲覧できます。',
    },
    {
      icon: '🔓',
      title: '有料版で広がる機能',
      body: '有料版では全500問を利用でき、分野別の章学習と途中再開、ランダム20問・30問、本試験型50問模試、重要数字マップ・混同ポイントの全件、全500問を対象とした復習・付箋・学習記録が利用できます。模試ではタイマーと途中再開にも対応しています。',
    },
    {
      icon: '🧪',
      title: 'ベータ版について',
    ...
    },
    {
      icon: '⚖️',
      title: '利用上の注意（免責）',
      body: '本アプリの問題・解説は学習用の参考情報であり、内容の正確性・完全性を保証するものではありません。試験の合否や学習成果を保証するものではなく、誤りが含まれる可能性があります。実務判断や受験上の最終確認は、最新の法令・公的機関・公式教材等をご確認ください。',
    },
    {
      icon: '💾',
      title: '学習データの保存について',
      body: '学習履歴・付箋・連続日数などは、お使いの端末のブラウザ内に保存されます。別の端末や別のブラウザには自動では引き継がれません。',
    },
    {
      icon: '🧹',
      title: 'データ削除時の注意',
      body: 'ブラウザの履歴・サイトデータを削除すると、学習記録が消える場合があります。アプリ内の学習データのリセット操作も元に戻せません。',
    },
    {
      icon: '📅',
      title: '法改正の基準日',
      body: '問題・解説は主に2026年6月時点で確認した法令・制度に基づいて作成・点検しています。試験に関する最新情報は、必ず公式の発表・最新の法令でご確認ください。',
    },
    {
      icon: '✅',
      title: '問題のレビュー状態',
